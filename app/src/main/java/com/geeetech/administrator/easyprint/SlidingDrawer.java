...
public class SlidingDrawer extends LinearLayout {
    ...
    public void open() {
        ...
        if (mStatus == STATUS_CLOSED || mStatus == STATUS_OPEN_PARTLT) {
            ...
            mStatus = STATUS_OPEN;
            PrintFragment.mViewModel.setVisibility(GONE);
            PrintFragment.mSlidingOpen.setVisibility(GONE);
            PrintFragment.mViewTransparent.setVisibility(VISIBLE);
        }
    }
    ...
    public void close() {
        ...
        if (mStatus == STATUS_OPEN_PARTLT || mStatus == STATUS_OPEN) {
            ...
            PrintFragment.mViewModel.setVisibility(VISIBLE);
            PrintFragment.mSlidingOpen.setVisibility(VISIBLE);
            PrintFragment.mViewTransparent.setVisibility(GONE);
        }
    }
    ...
    private void startAnimation(int fromLength, int toLength) {
        ...
        mAnimator.setDuration(100);//ANIMATION_DURATION
        mAnimator.setInterpolator(new AccelerateInterpolator());//new AccelerateDecelerateInterpolator()
