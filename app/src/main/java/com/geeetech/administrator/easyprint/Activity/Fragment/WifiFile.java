...
public class WifiFile extends Fragment {
    ...
    public static WifiFile newInstance(String info) {
        Bundle args = new Bundle();
        WifiFile fragment = new WifiFile();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_3dwifi, null);
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                if ( serialNumber.indexOf("3DWF") < 0){
                    mLinearLayout.setVisibility(View.GONE);
                    return;
                }
    ...
    public void getRefresh() throws JSONException {
        ...
        String url = Urls.USER_COMMON() + encryStr + "/printers/" + encryStrId +"/boxsds";
    ...
    private void getFileList(){
        ...
        String url = Urls.USER_COMMON() + encryStr + "/printers/" + encryStrId +"/boxsds?token=" + token;
        OkGo.<String>get(url)
                .tag(this)
                .execute(new StringCallback() {
                    @Override
    ...
    public void getPrint(String name) throws JSONException {
        ...
        js.put("value",name +"3D");
        js.put("token",token);
        SdCard.mPrintFileName = name;
